...
const CompanyVision = ({title, pathImage, visionStatement, nameImage}) => {
   ...
   return (
      <div className="bg-gray-900">
         <div className="grid max-w-screen-xl px-4 py-2 mx-auto gap-8 lg:grid-cols-12">
            <div className="lg:order-first mt-0 lg:col-span-5 lg:flex flex flex-col items-center">
               <img src={imageUrl} alt={nameImage} className="w-1/2 lg:w-[100%]"/>
            </div>
            <div className="order-first mr-auto place-self-center lg:order-first lg:col-span-7">
               <h1
               ...
               <p className="max-w-3xl text-center lg:text-start mb-2 font-light md:text-lg lg:text-xl text-gray-400">
                  {visionStatement}
               </p>
            </div>
         </div>
