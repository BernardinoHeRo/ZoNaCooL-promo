...
const Hero = () => {
    return (
        <div className="bg-zc-first border-t-[1px] border-t-zc-fourth text-zc-neutral-100 py-10">
            <div className="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
                <div className="flex flex-col w-full lg:w-1/3 justify-center items-center p-8">
                    <h1 className="text-5xl p-2 text-zc-first-comp brightness-200 contrast-200
